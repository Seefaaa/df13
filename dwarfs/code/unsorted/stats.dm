...
/obj/item/clothing/suit/leather_vest/apply_grade(grade)
    ...
    switch(grade)
        if(1)
            armor.setRating(sharp=2, pierce=2, blunt=0, fire=0, wound=10)
        if(2)
            armor.setRating(sharp=5, pierce=4, blunt=3, fire=2, wound=15)
        if(3)
            armor.setRating(sharp=8, pierce=7, blunt=5, fire=4, wound=20)
        if(4)
            armor.setRating(sharp=14,pierce=10,blunt=7, fire=6, wound=25)
        if(5)
            armor.setRating(sharp=17,pierce=12,blunt=9, fire=8, wound=30)
        if(6)
...
/obj/item/clothing/gloves/leather/apply_grade(grade)
    ...
    switch(grade)
        if(1)
            armor.setRating(sharp=2, pierce=3, blunt=2, fire=1, wound=5)
        if(2)
            armor.setRating(sharp=4, pierce=5, blunt=4, fire=3, wound=10)
        if(3)
            armor.setRating(sharp=7,pierce=8, blunt=7, fire=5, wound=15)
        if(4)
            armor.setRating(sharp=10,pierce=10,blunt=9, fire=8, wound=20)
        if(5)
            armor.setRating(sharp=12,pierce=12,blunt=12,fire=10, wound=25)
        if(6)
...
/obj/item/clothing/shoes/leather_boots/apply_grade(grade)
    ...
    switch(grade)
        ...
        if(2)
            armor.setRating(sharp=4, pierce=5, blunt=4, fire=3, wound=10)
        if(3)
            armor.setRating(sharp=8,pierce=7, blunt=7, fire=5, wound=15)
        if(4)
            armor.setRating(sharp=11,pierce=10,blunt=9, fire=8, wound=20)
        if(5)
            armor.setRating(sharp=15,pierce=13,blunt=12,fire=9, wound=25)
        if(6)
            armor.setRating(sharp=17,pierce=15,blunt=15,fire=11,wound=30)
