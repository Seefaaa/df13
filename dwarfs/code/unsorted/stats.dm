...
/obj/item/clothing/suit/light_plate/apply_grade(_grade)
    ...
    switch(grade)
        if(1)
            armor = armor.setRating(sharp=6, pierce=2, blunt=0, fire=4, wound=15)
        if(2)
            armor = armor.setRating(sharp=9, pierce=4, blunt=3, fire=5, wound=20)
        if(3)
            armor = armor.setRating(sharp=12,pierce=8, blunt=5, fire=6, wound=25)
        if(4)
            armor = armor.setRating(sharp=16,pierce=10,blunt=7, fire=7, wound=30)
        if(5)
            armor = armor.setRating(sharp=19,pierce=12,blunt=9, fire=8, wound=35)
        if(6)
            armor = armor.setRating(sharp=23,pierce=15,blunt=14,fire=9, wound=40)

/obj/item/clothing/suit/heavy_plate/apply_grade(_grade)
    ..()
    switch(grade)
        if(1)
            armor = armor.setRating(sharp=9, pierce=3, blunt=2, fire=6, wound=20)
        if(2)
            armor = armor.setRating(sharp=12,pierce=5, blunt=5, fire=7, wound=25)
        if(3)
            armor = armor.setRating(sharp=15,pierce=9, blunt=8, fire=8, wound=30)
        if(4)
            armor = armor.setRating(sharp=18,pierce=12,blunt=11,fire=9, wound=40)
        if(5)
            armor = armor.setRating(sharp=24,pierce=14,blunt=14,fire=10,wound=45)
        if(6)
            armor = armor.setRating(sharp=30,pierce=17,blunt=18,fire=11,wound=50)
...
/obj/item/clothing/head/heavy_plate/apply_grade(_grade)
    ...
    switch(grade)
        if(1)
            armor = armor.setRating(sharp=5, pierce=3, blunt=2, fire=5, wound=15)
        if(2)
            armor = armor.setRating(sharp=9, pierce=5, blunt=4, fire=6, wound=20)
        if(3)
            armor = armor.setRating(sharp=13,pierce=8, blunt=7, fire=7, wound=25)
        if(4)
            armor = armor.setRating(sharp=17,pierce=11,blunt=9, fire=8, wound=30)
        if(5)
            armor = armor.setRating(sharp=20,pierce=13,blunt=12,fire=9, wound=35)
        if(6)
            armor = armor.setRating(sharp=23,pierce=16,blunt=15,fire=10,wound=40)
