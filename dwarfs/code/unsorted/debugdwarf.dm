...
/datum/outfit/dwarf/debug/post_equip(mob/living/carbon/human/H, visualsOnly)
	. = ..()
	if(!visualsOnly)
		H.mind.set_experience(/datum/skill/mining,SKILL_EXP_LEGEND, TRUE)
		H.mind.set_experience(/datum/skill/martial,SKILL_EXP_LEGEND, TRUE)
		H.mind.set_experience(/datum/skill/logging,SKILL_EXP_LEGEND, TRUE)
		H.mind.set_experience(/datum/skill/farming,SKILL_EXP_LEGEND, TRUE)
		H.mind.set_experience(/datum/skill/butchering,SKILL_EXP_LEGEND, TRUE)
		H.mind.set_experience(/datum/skill/cooking,SKILL_EXP_LEGEND, TRUE)
		H.mind.set_experience(/datum/skill/combat,SKILL_EXP_LEGEND, TRUE)
